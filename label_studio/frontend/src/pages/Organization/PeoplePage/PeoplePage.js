  ...
  return (
    <Block name="invite">
      ...
      <Description style={{ width: '70%', marginTop: 16 }}>
        Invite people to join your Siali Label instance. People that you invite have full access to all of your projects. <a href="https://labelstud.io/guide/signup.html">Learn more</a>.
      </Description>
    </Block>
  );
};
