...
"""
"""
Django Base settings for Siali Label.
    ...
    'SECURITY_DEFINITIONS': {
        'Token': {
            ...
            'description':
                ...
                'You can find your user token on the User Account page in Siali Label. Example: '
...
# Email backend
FROM_EMAIL = get_env('FROM_EMAIL', 'Siali Label <hello@labelstud.io>')
