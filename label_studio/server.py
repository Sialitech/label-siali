...
def main():
    ...
    if input_args.command == 'version' or input_args.version:
        ...
        print('\nSiali labeling version:', __version__, '\n')
    ...
    # init
        ...
        print('')
        print('Siali labeling has been successfully initialized.')
        ...
        if not _project_exists(input_args.project_name):
            ...
            if project_path.exists():
                ...
                print(
                    Fore.LIGHTYELLOW_EX +
                    '\n*** WARNING! ***\n'
                    + f'Project {input_args.project_name} migrated to Siali labeling Database\n'
    ...
    # on `start` command, launch browser if --no-browser is not specified and start Siali labeling server
    if input_args.command == 'start' or input_args.command is None:
        ...
        if cert_file or key_file:
            logger.error("Siali labeling doesn't support SSL web server with cert and key.\n"
