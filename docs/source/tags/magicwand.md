...
meta_description: Customize Siali Label with a Magic Wand tag to quickly click and drag to threshold flood fill image areas during image segmentation labeling for machine learning and data science projects.
---
...
- Setting an environment variable when starting the Siali Label server, either by starting up the
...
[Siali Label storage guide](../guide/storage.html#Troubleshoot-CORS-and-access-problems) for more
...
use Siali Label's signed URL support ([AWS](../guide/storage.html#Set-up-connection-in-the-Label-Studio-UI),
...
If the image is on the same host as your Siali Label instance, you can simply leave off the
