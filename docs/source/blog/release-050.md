---
title: Siali Label Release Notes 0.5.0
type: blog
order: 102
meta_title: Siali Label Release Notes 0.5.0
meta_description: Siali Label Release 0.5.0 includes image segmentation, relations labeling, named entity recognition performance, image ellipses labeling, and more.
---
...
- by [specifying path](/guide/tasks.html#Import-formats) to a file or directory with images, audios or text files on Siali Label initialization
...
[Connecting to a running machine learning backend](/guide/ml.html) allows you to retrain your model continually and visually inspect how its predictions behave on tasks. Just specify ML backend URL when launching Siali Label, and start labeling.

## Miscellaneous

### Docker support

Now Siali Label is also maintained and distributed as Docker container - [run one-liner](/guide/index.html#Running-with-Docker) to build your own cloud labeling solution.

### Multisession mode

You can launch Siali Label in [multisession mode](/guide/#Multisession-mode) - then each browser session dynamically creates its own project. 
