...
Process the training images in the dataset with Tesseract and prepare to correct the results with Siali Label.
...
## Takeaways for OCR with Tesseract and Siali Label
