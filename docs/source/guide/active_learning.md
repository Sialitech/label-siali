---
title: Set up active learning with Siali Label
short: Active learning loop
tier: enterprise
type: guide
order: 304
order_enterprise: 117
meta_title: Set up an active learning loop with Siali Label
meta_description: Set up an end-to-end active learning loop with Siali Label using the ML backend SDK and webhooks to perform model training and predictions and labeling.
section: "Machine learning"

---

Follow this tutorial to set up an active learning loop with Siali Label. 

<div class="enterprise-only">

<p>
Use Siali Label Enterprise Edition to build an automated active learning loop with a machine learning model backend. If you use the open source Community Edition of Siali Label, you can manually sort tasks and retrieve predictions to mimic an active learning process. If you're using Siali Label Community Edition, see <a href="#Customize-your-active-learning-loop">how to customize your active learning loop</a>.
</p>
...
Continuously train and review predictions from a connected machine learning model using Siali Label. 
...
2. [Connect the ML backend for getting predictions to Siali Label](#Connect-the-ML-backend-to-Label-Studio-for-active-learning).
...
As you label tasks, Siali Label sends webhook events to your machine learning backend and prompts it to retrain. As the model retrains, the predictions from the latest model version appear in Siali Label. 
...
## Connect the ML backend to Siali Label for active learning

1. Follow the steps to [Add an ML backend to Siali Label](ml.html#Add-an-ML-backend-to-Label-Studio).
...
By default, Siali Label notifies your ML backend every time an annotation is created or updated so that it can start training in response. 
...
1. In the Siali Label UI, open the project that you want to use for active learning.
...
As your model retrains and a new version is updated in Siali Label, the tasks shown next to annotators are always those with the lowest prediction scores, reflecting those with the lowest model certainty. The predictions for the tasks correspond to the latest model version.
...
If you're using Siali Label community edition, data annotators can't experience a live active learning loop. You can mimic an active learning experience by doing the following:
